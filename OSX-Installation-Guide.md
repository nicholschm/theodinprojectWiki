...
If you run into a issue such as `No daemon found matching 'postgres'` at this point you can use [Postgres.app](https://postgresapp.com/) instead of lunchy to get `postgres` set up and running on OSX.
